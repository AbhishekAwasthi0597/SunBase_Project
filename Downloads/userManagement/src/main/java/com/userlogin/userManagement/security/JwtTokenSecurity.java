package com.userlogin.userManagement.security;
...
public class JwtTokenSecurity {
    ...
    public boolean isTokenValid(String token, AdminLoginEntity userDetails) {
        final String email=extractAdminId(token);
        String validData=userDetails.getUsername()+"@@"+userDetails.getPassword();
